...
public class DuquZuoBiao {


	public ArrayList duquzuobiao(String filePath) throws Exception{
		String str=null;
		String str2=null;
		String str3=null;
		String str4=null;
			...
			if(file11.isFile() && file11.exists()){ //判断文件是否存在 
				...
				while((str1 = bufferedReader.readLine()) != null){ 
					...
					if(str1.indexOf("<trkpt",1)>0){
						str2=str1.substring(str1.indexOf("<trkpt",1)+1,str1.lastIndexOf(">"));
						System.out.println(str2);
						//str3=str2.substring(0,);//+" "+str2.substring(str2.lastIndexOf("T")+1,str2.lastIndexOf("Z"));
